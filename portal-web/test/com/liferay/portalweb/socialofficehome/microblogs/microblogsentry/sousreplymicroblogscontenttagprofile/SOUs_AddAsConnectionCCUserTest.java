...
package com.liferay.portalweb.socialofficehome.microblogs.microblogsentry.sousreplymicroblogscontenttagprofile;
...
public class SOUs_AddAsConnectionCCUserTest extends BaseTestCase {
	public void testSOUs_AddAsConnectionCCUser() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Add as Connection"),
			selenium.getText(
				"//button[@id='_1_WAR_contactsportlet_addConnectionButton']/span[2]"));
		selenium.clickAt("//button[@id='_1_WAR_contactsportlet_addConnectionButton']/span[2]",
