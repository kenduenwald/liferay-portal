 ...
 */
public class SOUs_ViewTasksTaskAssignedToConnectionUTTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewTasksTaskAssignedToConnectionUTTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInTest.class);
		testSuite.addTestSuite(SOUs_ViewTasksTaskAssignedToConnectionUTTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOSignInTest.class);
